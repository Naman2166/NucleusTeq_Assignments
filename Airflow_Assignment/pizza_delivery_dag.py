...
with DAG(
    ...
    schedule_interval='0 11-13,17-20 * * *',
    catchup=False,
    ...
    def order_status(task_instance):
        payload = task_instance.xcom_pull(task_ids='take_order', key='order_data')
    ...
    order_status = PythonOperator(
        task_id='order_status',
        python_callable=order_status,
    ...
    bake_pizza >> check_quality >> pack_box >> start_delivery >> order_status
