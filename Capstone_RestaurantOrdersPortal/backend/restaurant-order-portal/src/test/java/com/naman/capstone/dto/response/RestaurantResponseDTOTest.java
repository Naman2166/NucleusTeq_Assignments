...
class RestaurantResponseDTOTest {
    ...
    void test_constructor() {
        RestaurantResponseDTO dto = new RestaurantResponseDTO(1L, "Dominos", "AB Road, Indore", RestaurantStatus.OPEN, "image.jpg");
    ...
    void test_equals_and_hashcode_same() {
        RestaurantResponseDTO r1 = new RestaurantResponseDTO(1L, "Dominos", "AB Road", RestaurantStatus.OPEN, "img.jpg");
        RestaurantResponseDTO r2 = new RestaurantResponseDTO(1L, "Dominos", "AB Road", RestaurantStatus.OPEN, "img.jpg");
        assertEquals(r1, r2);
    ...
    void test_equals_and_hashcode_different() {
        RestaurantResponseDTO r1 = new RestaurantResponseDTO(1L, "Dominos", "AB Road", RestaurantStatus.OPEN, "img.jpg");
        RestaurantResponseDTO r2 = new RestaurantResponseDTO(2L, "Burger King", "Vijay Nagar", RestaurantStatus.CLOSED, "img2.jpg");
    ...
    @Test
    void test_to_string() {
        RestaurantResponseDTO dto = new RestaurantResponseDTO(1L, "Dominos", "AB Road", RestaurantStatus.OPEN, "image.jpg");
