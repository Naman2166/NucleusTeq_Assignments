...
async def create_question(
    ...
    """
    logger.info(f"Create question requested by {current_user['email']}")
...
async def get_question_by_id(
    ...
    """
    logger.info(f"Get question {question_id} requested by {current_user['email']}")
    response = await QuestionService.get_question_by_id(question_id)
    return response
...
async def get_questions_by_quiz(
    ...
    """
    logger.info(f"Get questions for quiz {quiz_id} requested by {current_user['email']}")
...
async def update_question(
    ...
    Update a question
    """
    logger.info(f"Update question {question_id} requested by {current_user['email']}")
...
async def delete_question(
    ...
    Delete a question
    """
    logger.info(f"Delete question {question_id} requested by {current_user['email']}")
